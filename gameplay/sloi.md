...
<div data-full-width="false"><figure><img src="../.gitbook/assets/image (37).png" alt="" width="403"><figcaption><p>Загрузка всех слоев мира</p></figcaption></figure></div>
...
{% hint style="info" %}
Свойство isLoadOnStart часто используется для слоев которые связаны с квестами, так как слои квестов загружаются отдельно в файле квеста с помощью ноды [hide/show layers](broken-reference), такой приём используется для подконтрольной загрузке слоев квеста. Детальнее [тут](broken-reference).
{% endhint %}
