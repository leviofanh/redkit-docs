...
Дальность прорисовки можно изменить:

- В свойствах меша
- Для каждого объекта мира в отдельности

### Свойства меша

В свойствах каждого меша (в редакторе w2mesh файлов) есть глобальный параметр **autoHideDistance**, который задает значение дистанции прорисовки по умолчанию для этого меша.

<image src="../../../.gitbook/assets/mesh_sett.png" alt="Скриншот свойств меша">

### Свойства объекта в мире

Если вам необходимо изменить дальность прорисовки для конкретного меша в мире или вы не можете изменить глобальный параметр в настройках меша, можно воспользоваться параметром **forceAutoHideDistance**. Этот параметр переопределяет глобальное значение для конкретного меша. Значение 0 использует значение по умолчанию.
