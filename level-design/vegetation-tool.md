...
Vegetation Edit Tool — это утилита для создания и редактирования растительности. С его помощью можно добавлять, настраивать и удалять растительность на уровне.
...
Для клонирования кисти выберете кисть которую вы хотите клонировать и нажмите на ![](<../.gitbook/assets/image (82).png>).
...
{% hint style="info" %}
Рисование положение учитывает [режим рисования](vegetation-tool.md#rezhimy-risovaniya).
{% endhint %}
