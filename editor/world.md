...
Согласно концепции Witcher 3, **Миры** разделяют игру на зоны интереса и реализуют отдельные участки глобальной карты.
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>Путь к файлу мира во внешнем источнике. Используется для импорта миров, созданных или измененных вне редактора REDKit. В рамках большинства ситуаций использоваться не будет.</td>
        </tr>
        <tr>
            <td><strong>importFileTimeStamp</strong></td>
            <td>Время последнего изменения (загрузки) внешнего файла мира.</td>
        </tr>
        <tr>
            <td><strong>initialyHiddenLayerGroups</strong></td>
            <td>Ссылка на внутренний файл с информацией о слоях, которые не будут загружены на старте <strong>мира</strong>. Такие слои обычно используются для отображения изменений мира в ходе игрового процесса.</td>
        </tr>
        <tr>
            <td><strong>umbraScene</strong></td>
        ...
        <tr>
            ...
            <td>Перечень настроек расчета навигации. <i>Ряд настроек имеют продвинутый характер и не меняются при работе с большинством <strong>миров</strong>, поэтому они будут опущены.</i></td>
        </tr>
        <tr>
        ...
        <tr>
            <td><strong>worldDimensions</strong></td>
            <td>Размер мира.</td>
        </tr>
        <tr>
            <td><strong>shadowConfig</strong></td>
            <td>Настройки теней в рамках <strong>мира</strong>. <i>Большая часть настроек имеют продвинутый характер и не меняются при работе с большинством <strong>миров</strong>, поэтому они будут опущены</i>.</td>
        </tr>
        <tr>
        ...
        <tr>
            <td><strong>environmentParameters</strong></td>
        ...
        <tr>
            ...
            <td>Ссылка на файл с шаблонами погоды для <strong>мира</strong>. Этот файл содержит различные варианты погоды и полные настройки того, как она ведет себя в рамках заданного <strong>мира</strong>.</td>
        </tr>
        <tr>
        ...
        <tr>
            <td><i>- skybox</i></td>
            <td>Параметры неба. <i>Это настройки по-умолчанию для стартового отображения <strong>мира</strong></i>.</td>
        </tr>
        <tr>
            <td><i>- sunMesh</i></td>
        ...
        <tr>
            ...
            <td>Настройки прорисовки различных элементов <strong>мира</strong>. <i>Это продвинутые настройки, требующие углубленных знаний. Используйте имеющиеся настройки из текущих миров, для достижения желаемого результата</i>.</td>
        </tr>
        <tr>
